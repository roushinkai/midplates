ShaguPlates:RegisterModule("gui", "vanilla:tbc", function ()
  ...
  do -- DropDown Menus
    ...
    ShaguPlates.gui.dropdowns = {
      ...
      ["namevertical"] = {
        "above:Above the healthbar",
        "inside:Inside the healthbar",
        "below:Below the healthbar",
      },
    }
  ...
  do -- Generate Config UI
    CreateGUIEntry(T["Nameplates"], nil, function()
      ...
      CreateConfig(U["nameplates"], T["Name Text Horizontal Position"], C.nameplates, "nametexthalign", "dropdown", ShaguPlates.gui.dropdowns.textalign)
      CreateConfig(U["nameplates"], T["Name Text Vertical Position"], C.nameplates, "nametextvalign", "dropdown", ShaguPlates.gui.dropdowns.namevertical)
      ...
      CreateConfig(U["nameplates"], T["Disable Red Name Text On Aggro"], C.nameplates, "disableaggrored", "checkbox")
      CreateConfig(U["nameplates"], T["Disable Yellow Name Text On Target"], C.nameplates, "disabletargetyellow", "checkbox")
      ...
      CreateConfig(U["nameplates"], T["Hide Level Text"], C.nameplates, "hidelevel", "checkbox")
      ...
      CreateConfig(U["nameplates"], T["Spell Name Position"], C.nameplates, "spellnameposition", "dropdown", { "inside:Inside", "above:Above", "outside:Outside" })
      CreateConfig(U["nameplates"], T["Spell Name Horizontal Alignment"], C.nameplates, "spellnamehalign", "dropdown", { "LEFT:Left", "CENTER:Center", "RIGHT:Right" })
      CreateConfig(U["nameplates"], T["Castbar Height"], C.nameplates, "heightcast")
      CreateConfig(U["nameplates"], T["Castbar Icon Position"], C.nameplates, "castbariconposition", "dropdown", { "inside:Inside", "outside:Outside" })
      CreateConfig(U["nameplates"], T["Castbar Backdrop Color"], C.nameplates, "castbar_backdrop", "color")
      CreateConfig(U["nameplates"], T["Show Cast Target"], C.nameplates, "showcasttarget", "checkbox")

      CreateConfig(nil, T["Debuffs"], nil, nil, "header")
      CreateConfig(U["nameplates"], T["Enable Debuffs"], C.nameplates, "showdebuffs", "checkbox")
      CreateConfig(nil, T["Debuff Durations on nameplates"], C.appearance.cd, "debuffs", "checkbox")
      ...
      CreateConfig(U["nameplates"], T["Debuff Icon Width"], C.nameplates, "debuffwidth")
      CreateConfig(U["nameplates"], T["Debuff Icon Horizontal Spacing"], C.nameplates, "debuffspacing")
      ...
      CreateConfig(U["nameplates"], T["Healthbar Backdrop Color"], C.nameplates, "healthbar_backdrop", "color")
      ...
      CreateConfig(nil, T["Remove all but last name"], C.nameplates, "removelastname", "checkbox")
      ...
      CreateConfig(U["nameplates"], T["Disable Debuff Timers on Nameplates"], C.nameplates, "disable_debuff_timers", "checkbox")
