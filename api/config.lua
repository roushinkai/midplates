...
function ShaguPlates:LoadConfig()
  ...
  ShaguPlates:UpdateConfig("global",     nil,           "font_unit_name",   "Fonts\\FRIZQT__.TTF")
  ShaguPlates:UpdateConfig("global",     nil,           "font_combat",      "Fonts\\FRIZQT__.TTF")
  ...
  ShaguPlates:UpdateConfig("appearance", "border",      "color",            "0.3,0.3,0.3,0.7")
  ...
  ShaguPlates:UpdateConfig("appearance", "border",      "nameplates",       "1")
  ...
  ShaguPlates:UpdateConfig("appearance", "cd",          "font_size",        "14")
  ShaguPlates:UpdateConfig("appearance", "cd",          "font_size_blizz",  "14")
  ShaguPlates:UpdateConfig("appearance", "cd",          "font_size_foreign","14")
  ShaguPlates:UpdateConfig("appearance", "cd",          "debuffs",          "0")
  ShaguPlates:UpdateConfig("appearance", "cd",          "blizzard",         "0")
  ShaguPlates:UpdateConfig("appearance", "cd",          "foreign",          "0")
  ShaguPlates:UpdateConfig("appearance", "cd",          "milliseconds",     "0")
  ...
  ShaguPlates:UpdateConfig("appearance", "castbar",     "texture",          "Interface\\AddOns\\ShaguPlates\\img\\bar")
  ...
  for _, unit in pairs(ufs) do
    ...
    ShaguPlates:UpdateConfig("unitframes", unit,      "txthpleftoffx",    "0")
    ShaguPlates:UpdateConfig("unitframes", unit,      "txthpleftoffy",    "0")
    ShaguPlates:UpdateConfig("unitframes", unit,      "txthpcenter",      "none")
    ShaguPlates:UpdateConfig("unitframes", unit,      "txthpcenteroffx",    "0")
    ShaguPlates:UpdateConfig("unitframes", unit,      "txthpcenteroffy",    "0")
    ShaguPlates:UpdateConfig("unitframes", unit,      "txthpright",       "healthdyn")
    ShaguPlates:UpdateConfig("unitframes", unit,      "txthprightoffx",    "0")
    ShaguPlates:UpdateConfig("unitframes", unit,      "txthprightoffy",    "0")
    ShaguPlates:UpdateConfig("unitframes", unit,      "txtpowerleft",     "none")
    ShaguPlates:UpdateConfig("unitframes", unit,      "txtpowerleftoffx",    "0")
    ShaguPlates:UpdateConfig("unitframes", unit,      "txtpowerleftoffy",    "0")
    ShaguPlates:UpdateConfig("unitframes", unit,      "txtpowercenter",   "none")
    ShaguPlates:UpdateConfig("unitframes", unit,      "txtpowercenteroffx",    "0")
    ShaguPlates:UpdateConfig("unitframes", unit,      "txtpowercenteroffy",    "0")
    ShaguPlates:UpdateConfig("unitframes", unit,      "txtpowerright",    "none")
    ShaguPlates:UpdateConfig("unitframes", unit,      "txtpowerrightoffx",    "0")
    ShaguPlates:UpdateConfig("unitframes", unit,      "txtpowerrightoffy",    "0")
    ShaguPlates:UpdateConfig("unitframes", unit,      "hitindicator",     "0")
    ShaguPlates:UpdateConfig("unitframes", unit,      "hitindicatorsize", "15")
    ShaguPlates:UpdateConfig("unitframes", unit,      "hitindicatorfont", "Interface\\AddOns\\ShaguPlates\\fonts\\Continuum.ttf")
  ...
  ShaguPlates:UpdateConfig("bars",       nil,           "font",             "Interface\\AddOns\\ShaguPlates\\fonts\\BigNoodleTitling.ttf")
  ...
  ShaguPlates:UpdateConfig("castbar",    "focus",       "showtimer",        "0")
  ...
  ShaguPlates:UpdateConfig("tooltip",    "statusbar",   "texture",          "Interface\\AddOns\\ShaguPlates\\img\\bar")
  ShaguPlates:UpdateConfig("tooltip",     nil,          "font_tooltip",     "Interface\\AddOns\\ShaguPlates\\fonts\\Myriad-Pro.ttf")
  ...
  ShaguPlates:UpdateConfig("chat",       "global",      "maxlines",         "128")
  ...
  ShaguPlates:UpdateConfig("nameplates", nil,           "overlap",          "1")
  ShaguPlates:UpdateConfig("nameplates", nil,           "verticalhealth",   "0")
  ShaguPlates:UpdateConfig("nameplates", nil,           "vertical_offset",  "5")
  ShaguPlates:UpdateConfig("nameplates", nil,           "showcastbar",      "1")
  ShaguPlates:UpdateConfig("nameplates", nil,           "targetcastbar",    "1")
  ShaguPlates:UpdateConfig("nameplates", nil,           "spellname",        "1")
  ShaguPlates:UpdateConfig("nameplates", nil,           "spellnameposition",  "inside")
  ShaguPlates:UpdateConfig("nameplates", nil,           "spellnamehalign",  "LEFT")
  ShaguPlates:UpdateConfig("nameplates", nil,           "castbariconposition",  "inside")
  ShaguPlates:UpdateConfig("nameplates", nil,           "showdebuffs",      "1")
  ShaguPlates:UpdateConfig("nameplates", nil,           "selfdebuff",       "1")
  ...
  ShaguPlates:UpdateConfig("nameplates", nil,           "namefightcolor",   "0")
  ShaguPlates:UpdateConfig("nameplates", nil,           "disableaggrored",  "1")
  ...
  ShaguPlates:UpdateConfig("nameplates", nil,           "showtimer",        "0")

  ShaguPlates:UpdateConfig("nameplates", nil,           "outcombatstate",   "0")
  ...
  ShaguPlates:UpdateConfig("nameplates", nil,           "ccombatcasting",   "1")
  ...
  ShaguPlates:UpdateConfig("nameplates", nil,           "outfriendlynpc",   "0")
  ShaguPlates:UpdateConfig("nameplates", nil,           "outneutral",       "0")
  ShaguPlates:UpdateConfig("nameplates", nil,           "outenemy",         "0")
  ShaguPlates:UpdateConfig("nameplates", nil,           "targethighlight",  "1")
  ShaguPlates:UpdateConfig("nameplates", nil,           "highlightcolor",   "1,1,1,1")

  ShaguPlates:UpdateConfig("nameplates", nil,           "showhp",           "1")
  ShaguPlates:UpdateConfig("nameplates", nil,           "hptextpos",        "RIGHT")
  ShaguPlates:UpdateConfig("nameplates", nil,           "hptextformat",     "percent")
  ShaguPlates:UpdateConfig("nameplates", nil,           "vpos",             "-10")
  ShaguPlates:UpdateConfig("nameplates", nil,           "width",            "155")
  ShaguPlates:UpdateConfig("nameplates", nil,           "debuffsize",       "20")
  ShaguPlates:UpdateConfig("nameplates", nil,           "debuffwidth",      "22")
  ShaguPlates:UpdateConfig("nameplates", nil,           "debuffoffset",     "5")
  ShaguPlates:UpdateConfig("nameplates", nil,           "heighthealth",     "13.5")
  ShaguPlates:UpdateConfig("nameplates", nil,           "heightcast",       "13.5")
  ShaguPlates:UpdateConfig("nameplates", nil,           "cpdisplay",        "0")
  ShaguPlates:UpdateConfig("nameplates", nil,           "targetglow",       "0")
  ShaguPlates:UpdateConfig("nameplates", nil,           "glowcolor",        "1,1,1,1")
  ShaguPlates:UpdateConfig("nameplates", nil,           "targetzoom",       "1")
  ShaguPlates:UpdateConfig("nameplates", nil,           "targetzoomval",    ".15")
  ShaguPlates:UpdateConfig("nameplates", nil,           "notargalpha",      ".85")
  ShaguPlates:UpdateConfig("nameplates", nil,           "healthtexture",    "Interface\\AddOns\\ShaguPlates\\img\\bar")
  ShaguPlates:UpdateConfig("nameplates", "name",        "fontstyle",        "OUTLINE")
  ShaguPlates:UpdateConfig("nameplates", "health",      "offset",           "-4")
  ...
  ShaguPlates:UpdateConfig("nameplates", "debuffs",     "showstacks",       "1")
  ShaguPlates:UpdateConfig("nameplates", "debuffs",     "position",         "TOP")
  ShaguPlates:UpdateConfig("nameplates", nil,           "abbrevname",       "1")
  ShaguPlates:UpdateConfig("nameplates", nil,           "removelastname",   "1")
  ShaguPlates:UpdateConfig("nameplates", nil,           "nametexthalign",   "LEFT")
  ShaguPlates:UpdateConfig("nameplates", nil,           "nametextvalign",   "inside")
  ShaguPlates:UpdateConfig("nameplates", nil,           "hidelevel",        "1")
  ShaguPlates:UpdateConfig("nameplates", nil,           "disabletargetyellow",        "1")
  ShaguPlates:UpdateConfig("nameplates", nil,           "iconborderalpha",            "0.1")
  ShaguPlates:UpdateConfig("nameplates", nil,           "debuffborderalpha",          "0.4")
  ShaguPlates:UpdateConfig("nameplates", nil,           "debuffborderthickness",      "0.1")
  ShaguPlates:UpdateConfig("nameplates", nil,           "debuffwidth",                "22")
  ShaguPlates:UpdateConfig("nameplates", nil,           "debuffspacing",              "2.5")
  ShaguPlates:UpdateConfig("nameplates", nil,           "healthbar_backdrop",         "0,0,0,.7")
  ShaguPlates:UpdateConfig("nameplates", nil,           "castbar_backdrop",           "0,0,0,.7")
  ShaguPlates:UpdateConfig("nameplates", nil,           "showcasttarget",             "1")
  ShaguPlates:UpdateConfig("nameplates", nil,           "milliseconds",               "0")
  ...
  ShaguPlates:UpdateConfig("screenshot", nil,           "caption_font",     "Interface\\AddOns\\ShaguPlates\\fonts\\BigNoodleTitling.ttf")
...
function ShaguPlates:MigrateConfig()
  ...
  if checkversion(3, 0, 0) then
    ...
    if not strfind(ShaguPlates_config.global.font_default, "\\") then
      ShaguPlates_config.global.font_default = "Interface\\AddOns\\ShaguPlates\\fonts\\" .. ShaguPlates_config.global.font_default .. ".ttf"
    end

    -- migrate font_unit
    if not strfind(ShaguPlates_config.global.font_unit, "\\") then
      ShaguPlates_config.global.font_unit = "Interface\\AddOns\\ShaguPlates\\fonts\\" .. ShaguPlates_config.global.font_unit .. ".ttf"
    end

    -- migrate font_combat
    if not strfind(ShaguPlates_config.global.font_combat, "\\") then
      ShaguPlates_config.global.font_combat = "Interface\\AddOns\\ShaguPlates\\fonts\\" .. ShaguPlates_config.global.font_combat .. ".ttf"
    end
  end
