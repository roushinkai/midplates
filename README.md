...
**New Features:**
* **Name Abbreviation** Already existed in the addon, but now is stricter and abbreviates anything above 5 characters
* **Show only last name** Show only the last name of the target mob
* **Show cast target** Show the cast target of a spell in the cast bar
* **Hide debuff timers** Toggle to hide the debuff timers
* **Backdrop Alpha** Transparent background for the health bar and cast bar
